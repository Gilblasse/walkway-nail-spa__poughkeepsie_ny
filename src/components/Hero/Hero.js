...
export default function Hero({title}) {
    ...
    // const heroStyles = {backgroundImage: "url(./smile-blue-nails.jpg)"}
                    ...
                    <section id="Hero" >
                        <div className="hero-inner-wrapper">
                            ...
                            <div className="hero-main">
                                <p>Nails <span>& Pedicure</span></p>
                                <p>Divide Your Uniqness By Your Hands In Style</p>
